export const projects = [
  {
    ...
    image: process.env.PUBLIC_URL + "/images/animation.gif",
...

  {
    ...
    image: process.env.PUBLIC_URL + "/images/sneakersAnimation.gif",
...
{
  linkedinImage: process.env.PUBLIC_URL + '/images/linkedin.svg',
  githubImage: process.env.PUBLIC_URL + '/images/github.svg',
  linkedinLink: 'https://www.linkedin.com/in/dusan-milosavljevic-675ab5230/',
  githubLink: 'https://github.com/Exoldarium',
  mailImage: process.env.PUBLIC_URL + '/images/mail.svg'
}
];
